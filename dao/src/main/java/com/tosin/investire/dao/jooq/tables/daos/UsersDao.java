...
public class UsersDao extends DAOImpl<UsersRecord, User, UUID> {
     ...
     * upperInclusive</code>
     */
    public List<User> fetchRangeOfFirstName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<User> fetchByFirstName(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<User> fetchRangeOfLastName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<User> fetchByLastName(String... values) {
